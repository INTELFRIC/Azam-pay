...
use intelfric\Azampay\Traits\InputValidation;
use Exception;
...
class AzampayService
{
    ...
    const SUPPORTED_MNO = ['Airtel', 'Tigo', 'Halopesa', 'Azampesa','Mpesa'];
    ...
    {
        // The service is now constructed without immediate config access.
        // Configuration and token generation will be handled lazily.
    }

    /**
     * Initialize the service with configuration and generate the token.
     * This method should be called before any API interaction.
     *
     * @throws Exception
     */
    ...
    {
        $this->initialize(); // Ensure initialized before sending request
    ...
    {
        $this->initialize(); // Ensure initialized before sending disbursement request
